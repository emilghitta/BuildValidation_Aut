...
public class GSheet {
    ...
    /**
         ...
         * Add SPREADSHEETS to have read/write access
         */
    ...
    public static String getTokensDirectoryPath() {return TOKENS_DIRECTORY_PATH; }
    public static List<String> getSCOPES() {return SCOPES; }
    public static String getCredentialsFilePath() { return CREDENTIALS_FILE_PATH; }
    }
